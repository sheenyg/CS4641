...
AELayers = [ae.Layer("Sigmoid", units = 120), ae.Layer("Sigmoid", units=60), ae.Layer("Sigmoid", units=30)]
NNLayers = [mlp.Layer("Sigmoid", units = 120), mlp.Layer("Sigmoid", units = 75), mlp.Layer("Softmax", units= 5)]
...
result = ae.AutoEncoder(AELayers,warning=None, random_state=0, learning_rule=u'sgd', learning_rate=0.01, learning_momentum=0.9,
...
#autoencoder results
res = result.transform(traindata)
x_test = X_test
